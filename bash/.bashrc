...
# Expand directory variables during auto-complete
# cf. https://askubuntu.com/questions/70750/how-to-get-bash-to-stop-escaping-during-tab-completion
shopt -s direxpand
...
#
# => Put the string "user@hostname:~/directory/path" in the title bar (iTerm2)
# \[\e]2;\]\u@\h:\w\[\a\]
#
# => Put the current directory in the tab (iTerm2)
# \[\e]1;\]\W\[\a\]
#
